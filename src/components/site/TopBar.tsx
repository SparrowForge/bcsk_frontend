      ...
      <div className="mx-auto max-w-7xl px-4 h-9 flex items-center justify-between gap-3">
        <div className="flex items-center gap-4 min-w-0">
          <a
            ...
            className="flex items-center gap-1.5 hover:text-green-soft shrink-0"
          >
            ...
            <span className="hidden sm:inline">
              {c.whatsappDisplay}
              {c.hours && <span className="text-white/60"> ({c.hours})</span>}
            </span>
          </a>
          <a href={`mailto:${c.email}`} className="hidden md:flex items-center gap-1.5 hover:text-green-soft">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <Link href="/search" aria-label={t.nav.search} className="hover:text-green-soft">
